...
const BasicLink = props => {
  return (
    <a className={`link-icon ${props.klass}`}
      href={props.url}
      target="_blank"
...
const NavFooter = () => (
  <div style={{display: "flex", flexDirection: "column"}}>
    <BasicLink url={URL_KOFI} symbol={`${ICON_KOFI} Buy me a coffee (or tea)`} klass="nav-footer" />
    <BasicLink url={URL_SRC} symbol={`${ICON_SRC} Source code`} klass="nav-footer"/>
